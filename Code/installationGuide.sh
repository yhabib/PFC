...
tput sgr0
  ...
  tput cup 17 7
  echo "Por último esta estrada permite realizar todo el proceso, desde la descarga hasta la instalación automaticamente. Es"
  tput cup 19 7
  echo "la indicada cuando tenemos un equipo con acceso a internet."
