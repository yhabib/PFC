...
tput clear
tput cup 3 9
echo "Scipt encargado de la instalación desde una carpeta de todo le software necesaior"
tput cup 4 9
read -p "Indtroduzca por favor la ruta hasta el directorio en el que están almacenados todos los paquetes." directorioDownload

tput cup 5 9
read -p "Indtroduzca por favor la ruta hasta el directorio en el que desea realizar la instalación" directorioDownload
gotDirectorio directorioInstall
